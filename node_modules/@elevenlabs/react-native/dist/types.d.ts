...
import type { Incoming, Outgoing, Interruption, ConversationMetadata, Ping, Role as MessageRole, Mode as ConversationMode, Status, Callbacks, AsrInitiationMetadataEvent as AsrMetadataEvent } from "@elevenlabs/types";
...
export type AgentResponseCorrectionEvent = Incoming.AgentResponseCorrectionClientEvent;
export type AgentAudioEvent = Incoming.AudioClientEvent;
export type InterruptionEvent = Interruption;
export type InternalTentativeAgentResponseEvent = Incoming.TentativeAgentResponseInternalClientEvent;
...
export type ConversationEvent = UserTranscriptionEvent | AgentResponseEvent | AgentResponseCorrectionEvent | AgentAudioEvent | InterruptionEvent | InternalTentativeAgentResponseEvent | ConfigEvent | PingEvent | ClientToolCallEvent | VadScoreEvent | MCPToolCallClientEvent | MCPConnectionStatusEvent | AgentToolResponseEvent | ConversationMetadataEvent | AsrInitiationMetadataEvent | AgentChatResponsePartEvent;
